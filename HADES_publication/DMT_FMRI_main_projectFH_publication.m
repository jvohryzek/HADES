...
% Author: Jakub Vohryzek (jakub.vohryzek@gmail.com)
% Date: 14/06/2021
% adapted from FMRI_main_projectFH.m by Selen
% main file to project to functional harmonics
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
clear all;
close all;
...
folder.surf       = '/Volumes/workHD/HCPdata/Dense_Connectome/HCP_S1200_GroupAvg_v1/';
...
load('/Volumes/workHD/FunHarD/Basis_FunHarD_denseFC_vertex_GlobalMode_Yes.mat')
...
baseCC = '/Users/jakub/Matlab/Collaboration_Kringelbach/FunHarD/';
